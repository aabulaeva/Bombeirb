...
// Sprites of Bombs
#define MAP_BOMB_TTL1       "sprite/bomb1.png"
#define MAP_BOMB_TTL2       "sprite/bomb2.png"
#define MAP_BOMB_TTL3       "sprite/bomb3.png"
#define MAP_BOMB_TTL4       "sprite/bomb4.png"
#define MAP_EXP							"sprite/explosion.png"
...
static void map_load() {
	...
	bomb4 = image_load(MAP_BOMB_TTL4);
	bomb3 = image_load(MAP_BOMB_TTL3);
	bomb2 = image_load(MAP_BOMB_TTL2);
	bomb1 = image_load(MAP_BOMB_TTL1);
	explosion= image_load(MAP_EXP);
	bonus4 = image_load(IMG_BONUS_BOMB_RANGE_DEC);
	bonus3 = image_load(IMG_BONUS_BOMB_RANGE_INC);
	bonus2 = image_load(IMG_BONUS_BOMB_NB_DEC);
	bonus1 = image_load(IMG_BONUS_BOMB_NB_INC);
	bonus6 = image_load(IMG_BONUS_LIFE);
...
static void map_unload() {
	...
	SDL_FreeSurface(bonus4);

	SDL_FreeSurface(bonus3);
	SDL_FreeSurface(bonus2);
	SDL_FreeSurface(bonus1);
	SDL_FreeSurface(bonus6);
